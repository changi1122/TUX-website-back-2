...
public class GalleryListResponse {
    private List<GallerySimpleResponse> content;
    private PageInfo pageable;
    private long totalElements;

    public static GalleryListResponse of(Page<ReferenceRoom> page, Pageable pageable) {
        return GalleryListResponse.builder()
                .content(page.getContent().stream().map(GallerySimpleResponse::of).toList())
